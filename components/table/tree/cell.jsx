...
import { TreeContext, SelectionContext } from '../context';
...
export default class TreeCell extends React.Component {
    ...
    onTreeNodeClick = (record, e) => {
        e.stopPropagation();
        this._treeContext && this._treeContext.onTreeNodeClick(record);
    };
                    ...
                    return (
                        <SelectionContext.Consumer>
                            {selectionContext => {
                                ...
                                const { rowSelection } = selectionContext;
                                const {
                                    colIndex,
                                    record,
                                    prefix,
